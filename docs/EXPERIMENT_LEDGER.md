...
NEXT_DISCRIMINATING_TEST=verify restored ledger row preservation, then select one further simplification with P4V7 fixed; do not alter scheduler, +3m lead, checkpoint, authority, verification, bootstrap, or recovery semantics
```
